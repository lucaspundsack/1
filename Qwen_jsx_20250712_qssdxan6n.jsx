      ...
      <header className="bg-gray-900 text-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            {/* Logo */}
            <img
              src="https://i.imgur.com/1234567.png " // Replace with actual image URL or base64 data
              alt="Pundsack Maschinenbau-Mühlenbau GmbH"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#services" className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-md transition-colors">
                  Unsere Leistungen
                </a>
              </div>
            </div>
            <div className="relative">
              <img 
                src="https://i.imgur.com/ABCDEFG.png " // Replace with actual image URL or base64 data
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Seit über 35 Jahren steht unser Unternehmen für Qualität, Innovation und Zuverlässigkeit in der 
              industriellen Fertigung. Unsere langjährige Erfahrung und unser modernes Maschinenpark machen 
              uns zu Ihrem vertrauensvollen Partner für komplexe Fertigungsprojekte.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-sm">
              <img 
                src="https://i.imgur.com/HIJKLMN.png " // Replace with actual image URL or base64 data
                alt="Matec 5-Achs CNC Maschine" 
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-sm">
              <img 
                src="https://i.imgur.com/OPQRSTU.png " // Replace with actual image URL or base64 data
